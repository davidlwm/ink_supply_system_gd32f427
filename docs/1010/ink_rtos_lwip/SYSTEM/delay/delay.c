...
#define delay_osrunning		(xTaskGetSchedulerState()!=taskSCHEDULER_NOT_STARTED)	//OS�Ƿ����б��
#define delay_ostickspersec	configTICK_RATE_HZ	//OSʱ�ӽ���,��ÿ����ȴ���
#define delay_osintnesting 	(0)					//FreeRTOS��ʹ���ж�Ƕ�׼���,ֱ�ӷ���0
#endif
...
#elif defined(USE_FREERTOS)					//ʹ��FreeRTOS
	vTaskSuspendAll();						//����������
#else										//����UCOSII
...
//systick�жϷ�����,ʹ��OSʱ�õ�
// ע�⣺��ʹ��FreeRTOSʱ�����ж�����FreeRTOS��port.c�ṩ�����������ǵ�����¶���
#if !defined(USE_FREERTOS)
